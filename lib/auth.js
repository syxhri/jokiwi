...
export const whatsappSchema = z
  .string()
  .trim()
  .regex(/^628[0-9]{8,12}$/, "Nomor WhatsApp wajib diawali 628 (contoh: 628123456789)");

/** Helper untuk mengubah 08xxx atau +628xxx menjadi 628xxx secara otomatis */
export function formatPhone628(phone) {
  if (!phone) return "";
