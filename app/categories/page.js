...
import { getAllCategoriesForUser, getAllOrdersForUser, computeStats } from '../../lib/db.js';
...
export default async function CategoriesPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Kategori Joki Tugas</h1>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-2xl bg-white p-4 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500">Total Pendapatan (Semua Kategori)</h3>
